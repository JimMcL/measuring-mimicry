...
Since all length measurments are normalised by expressing relative to prosoma width, we do not have two raw variables to visualise here, i.e. Prosomoa width is always 1.
...
Prosomoa width is removed during normalisation, so this component cannot be visualised.
